...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	{
		id: SETTING_ITEM_ID.AGENT_PRESETS,
		section: "agent",
		title: "Agent Commands",
		description: "Manage agent commands and availability in agent dropdowns",
		keywords: [
			"agent",
			"commands",
			"dropdown",
	...
	{
		id: SETTING_ITEM_ID.AGENT_PROMPT_TEMPLATE,
		section: "agent",
		title: "Task Prompt Template",
		description: "Customize the prompt template sent to terminal agents",
		keywords: [
			"agent",
			"prompt",
			"template",
